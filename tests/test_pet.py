...
class TestPet:
    ...
    def test_add_pet_full_data(self):
        with allure.step("Подготовка полных данных для добавления нового питомца"):
            payload = {
                "id": 10,
                "name": "doggie",
                "category": {
...
# Отправить POST-запрос на /pet с подготовленными данными.
# Статус ответа: 200. Ответ содержит данные питомца, которые соответствуют отправленным
